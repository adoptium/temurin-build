...
We want to expand 'TemurinGenSBOM' with documentation that explains how to build OpenJDK with Temurin, not just what its built from, using CycloneDX formulation.
...
This will follow this [CycloneDX spec](https://cyclonedx.org/docs/1.6/json/#specVersion). This section will be updated and expanded throughout implementation.