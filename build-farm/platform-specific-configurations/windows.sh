...
then
  ...
  then
    ...
    then
      ...
      export CONFIGURE_ARGS_FOR_ANY_PLATFORM="${CONFIGURE_ARGS_FOR_ANY_PLATFORM} --with-msvcr-dll=/cygdrive/c/Windows/system32/msvcr120.dll --with-msvcp-dll=/cygdrive/c/Windows/system32/msvcp120.dll "
