...
class ParseVersion {
    ...
    static void main(String[] args) {
        ...
        if (parsedArgs.s) {
            ...
            version = new VersionInfo().parse(this, versionString, adoptBuildNumber)
        }
    ...
    private static VersionInfo parseFromStdIn(String[] args) {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (matcher.matches()) {
                VersionInfo version = new VersionInfo().parse(this, matcher.group("version"), args[args.length - 1])
                return version
            }
        }
