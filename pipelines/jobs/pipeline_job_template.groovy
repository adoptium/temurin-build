...
pipelineJob("${BUILD_FOLDER}/${JOB_NAME}") {
    ...
    parameters {
        ...
        stringParam('publishName', "", 'Name that determines the version of the release. This determines the file name and is used by the meta-data file. For example for Java 8 based releases: <code>jdk8u192-b12</code> or <code>jdk8u192-b12_openj9-0.12.1</code> and for Java 11 based releases <code>jdk-11.0.2+9</code> or <code>jdk-11.0.2+9_openj9-0.12.1</code>.')
