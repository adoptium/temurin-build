...
pipelineJob("${BUILD_FOLDER}/${JOB_NAME}") {
    ...
    parameters {
        ...
        stringParam('overridePublishName', "", '<strong>REQUIRED for OpenJ9</strong>: Name that determines the publish name (and is used by the meta-data file), defaults to scmReference.<br/>Nightly builds: Leave blank (defaults to a date_time stamp. OpenJ9 Release build Java 8 example <code>jdk8u192-b12_openj9-0.12.1</code> and for OpenJ9 Java 11 example <code>jdk-11.0.2+9_openj9-0.12.1</code>.')
