...
def buildConfigurations = [
        ...
        x64Linux  : [
                ...
                test                : [
                        nightly: ['sanity.openjdk', 'sanity.system', 'sanity.perf', 'sanity.external'],
                        release: ['sanity.openjdk', 'sanity.system', 'sanity.perf', 'sanity.external']
                ],
        ...
        x64Windows: [
                ...
                test                : ['sanity.openjdk', 'sanity.perf', 'sanity.system']
        ],
